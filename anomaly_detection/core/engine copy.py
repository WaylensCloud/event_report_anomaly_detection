...
class AnomalyDetectorEngine:
    ...
    def _run_periodic_phase_anomaly(
        ...
        for i in range(len(raw_y)):
            ...
            if eligible and state["post_warmup_grace_remaining"] > 0:
                warmup_width = max(
            ...
            anomaly_scores.append(abs_deviation / dynamic_scale_value if eligible else 0.0)
            ...
            if is_point_anomaly:
                ...
                if AnomalyDetectorEngine._candidate_segment_is_coherent(
                    ...
                    if shift_size >= shift_threshold:
                        ...
                        point_anomaly_flags[-1] = False
                        anomaly_scores[-1] = 0.0
            else:
